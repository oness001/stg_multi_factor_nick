...
if __name__ == "__main__":
    if 0:
        ...
        df = pd.read_csv(rf"D:\jason_src\策略多因子系统\15min_全品种优化_short\backtest_result_data-f-2_s-2_e-2_jzmode-d\optimization_GCmain\raw_evaluation_cache.csv").tail(30)
    ...
    if 1:
        ...
        n2 = 2
        n3 = 2
        output_dir=rf"D:\jason_src\策略多因子系统\15min_全品种优化_short\backtest_result_data-f-{n1}_s-{n2}_e-{n3}_jzmode-{BACKTEST_CONFIG.get('jz_mode')}"
        os.makedirs(output_dir, exist_ok=True)
        OPTIMIZATION_CONFIG = {
                                "population_size": 5000,  # 种群大小
                                "n_generations": 500,  # 迭代代数
                                }
        long_dir_data_path = rf'D:\jason_src\策略多因子系统\15min_全品种优化\信号和过滤'
        dir_data_path = rf'D:\jason_src\策略多因子系统\15min_全品种优化_short\信号和过滤'
        signal_list = load_json(rf'D:\jason_src\策略多因子系统\15min_全品种优化\backtest_result_data-f-2_s-3_e-2_jzmode-d_new\optimization_GCmain\raw_evaluation_cache_force_filtered.json').get('GCmain')
        ...
        STRATEGY_PARAMS_CONFIG = {symbol_id:
                ...
                load_json(rf'D:\jason_src\策略多因子系统\15min_全品种优化\backtest_result_data-f-2_s-3_e-2_jzmode-d_new\optimization_{symbol_id}\raw_evaluation_cache_force_filtered.json').get(symbol_id)[1]['items']))
